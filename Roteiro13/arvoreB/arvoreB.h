...
|TAD: Arvore B                                          |
|					      		                        |
| Baseado no material do Prof. Rafael Sachetto	        |
| Implementado por Guilherme C. Pena em 02/12/2023      |
+-------------------------------------------------------+ */
...
void pesquisaRec(Registro *x, Apontador ap){
    ...
    if (x->chave == ap->r[i - 1].chave) {
        printf("Registro (chave %d) encontrado!\n", x->chave);
